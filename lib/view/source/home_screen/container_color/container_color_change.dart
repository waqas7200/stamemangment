...
bool selected=false;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body:
      Obx(() {
        // Agar loding true hai to sirf spinner dikhao
        if (containerclick.loding.value) {
          return Center(
            child: SpinKitCircle(color: Colors.indigo, size: 50),
          );
        }
        return SingleChildScrollView(
          child: Column(
            children: [
              ...
              Center(
                child: Text(
                  'Temperature', style: GoogleFonts.poppins(fontSize: 25,
                        ...
                        child: Column(
                          children: [
                            Obx(() =>
                                InkWell(
                                  onTap: () {
                                    // containerclick.Updateloading();
                                    // containerclick.containercolor(1);
                                    containerclick.containercolor(1);
                                    Get.snackbar('On', 'you click on light');
                                  },
                                  child: Container(
                                    height: 50,
                                    width: 50,
                                    decoration: BoxDecoration(
                                        color: containerclick.selected.value ==
                                            1 ? Colors.indigo
                      ...
                      Padding(
                        ...
                        child: Column(
                          children: [
                            Obx(() =>
                                InkWell(
                                  onTap: () {
                                    ...
                                    Get.snackbar('Media', 'you click on media',
                            ...
                            Text(
                              'Media', style: GoogleFonts.poppins(fontSize: 16,
                                fontWeight: FontWeight.w400,
                                color: Colors.black),),
                          ],
                        ),
                            ...
                            Obx(() =>
                                InkWell(
                                  ...
                                  child: Container(
                                    ...
                                    size: 30,
                                    color: containerclick.selected.value == 3
                                        ? Colors.white
                                        : Colors.indigo,
                                  ),),
                                  ),
                        ...
                        return InkWell(
                            ...
                            child: Obx(() =>
                                Container(
                                  ...
                                  width: 70,
                                  decoration: BoxDecoration(
                                      color: containerclick.selectedgrid
                                          .value == index ? Colors.indigo
                                          : Colors.grey.shade300,
                                      border: Border.all(width: 0.2),
